...
c                        INVCORRECTOR.F
c*************************************************************************
c This subroutine calculates the 3rd order symplectic inverse corrector 
c given in Wisdom (2006)
c
c             Input:
...
c Last revision: 6/2/09
      ...
      subroutine invcorrector(nbod,npl,ntp,time,mass,j2rp2,j4rp4,xh,yh,
     &     zh,vxh,vyh,vzh,xht,yht,zht,vxht,vyht,vzht,istat,dt,tinc)
