...
c                  bar  ==> whether to do accel calcs in bary or hel frame
c
c
c                 longasc,argper,
...
c Last revision: 8/18/08 NAK
      ...
      subroutine getacch_tp(nbod,npl,ntp,time,mass,j2rp2,j4rp4,xh,yh,zh,
...
c...  get thr r^-3's  for the planets and test paricles
      ...
      call getacch_ir3_tp(ntp,1,xht,yht,zht,ir3ht,irht)
...
c...  now the third terms
     ...
     &        istat,axh3,ayh3,azh3,mcent)
      else

c     making new mass array for use in ah0
         call getacch_ah0(npl+1,nbod,mass,xh,yh,zh,ir3h,axh0,ayh0,
     &        azh0)
