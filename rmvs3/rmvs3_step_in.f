...
c Last revision: 10/3/96
      ...
      subroutine rmvs3_step_in(i1st,nbod,npl,ntp,mass,j2rp2,j4rp4,
...
c...  Internals
      ...
      real*8 masst(NPLMAX),perit(NTPMAX),time
...
C...          set up planets at t=0
     ...
     &                                 zpltb,xplte,yplte,zplte)
                 ...
                 call rmvs_step_in_tp(i1sttp,nbod,npl,nenci(i),masst,
     ...
     &              aoblx(i,j),aobly(i,j),aoblz(i,j),time,bar)
