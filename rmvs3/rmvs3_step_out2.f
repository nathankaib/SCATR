...
c Last revision: 
      ...
      subroutine rmvs3_step_out2(i1st,nbod,npl,ntp,mass,j2rp2,j4rp4,
     &           xbeg,ybeg,zbeg,xend,yend,zend,vxbeg,vybeg,
     &           vzbeg,vxend,vyend,vzend,xht,yht,zht,vxht,vyht,vzht,
     &           istat,dt,ienc0,isperi,peri,time,istart,bar)

      include '../swift.inc'
      include '../rmvs/rmvs.inc'

c...  Inputs Only: 
      integer nbod,ntp,i1st,istart,bar,npl
      real*8 mass(NPLMAX),dt,j2rp2,j4rp4
...
c.... if not just do a normal step and leave
      if(icflg.eq.0) then
          call step_kdk_tp(i1st,time,nbod,npl,ntp,mass,j2rp2,j4rp4,
     &              xbeg,ybeg,zbeg,xend,yend,zend,xht,yht,zht,vxht,vyht,
     &              vzht,istat,dt,bar)	
...
c...  Do the inner integration
      call rmvs3_step_in(i1sttp,nbod,npl,ntp,mass,j2rp2,j4rp4,xtmp,
...
c...  do a full step
      ...
      call step_kdk_tp(i1sto,time,nbod,npl,ntp,mass,j2rp2,j4rp4,
     &              xbeg,ybeg,zbeg,xend,yend,zend,
     &              xht,yht,zht,vxht,vyht,vzht,istattmp,dt,bar)	
