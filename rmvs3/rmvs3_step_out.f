...
c...  Internals
      integer i1sttp,i,j,ic,istattmp(NTPMAX,NSTAT),bar
      real*8 dto,time
...
c     initializing values of isperil (nak 09/07/06)
      do i=1,ntp
         isperil(i) = 10
      enddo
...
c...      remember the current position of the planets
          ...
          call rmvs3_step_out2(i1sttp,nbod,npl,ntp,mass,j2rp2,j4rp4,
     &         xbegi,ybegi,zbegi,xendi,yendi,zendi,vxbegi,vybegi,
     &         vzbegi,vxendi,vyendi,vzendi,xht,yht,zht,
     &         vxht,vyht,vzht,istattmp,dto,ienc,isperil,peril,time,
     &         istart,bar)
