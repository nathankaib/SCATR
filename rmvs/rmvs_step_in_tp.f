...
c Last revision: 
      ...
      subroutine rmvs_step_in_tp(i1st,nbod,npl,ntp,mass,j2rp2,j4rp4,
     &              xbeg,ybeg,zbeg,xend,yend,zend,
     &              xht,yht,zht,vxht,vyht,vzht,istat,dt,ipl,
     &              aoblxb,aoblyb,aoblzb,aoblxe,aoblye,aoblze,time,
     &              bar)
...
c...  Inputs Only: 
      integer nbod,ntp,i1st,ipl,bar,npl
...
c...      Get the accelerations in helio frame
          call getacch_tp(nbod,npl,ntp,time,mass,j2rp2i,j4rp4i,xbeg,
     &        ybeg,zbeg,xht,yht,zht,istat,axht,ayht,azht,dt,mass(1),bar)
...
c...  Get the accelerations in helio frame.
      call getacch_tp(nbod,npl,ntp,time,mass,j2rp2i,j4rp4i,xend,yend,
     &     zend,xht,yht,zht,istat,axht,ayht,azht,dt,mass(1),bar)
