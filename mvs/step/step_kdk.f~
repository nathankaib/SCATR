...
c Last revision: 9/26/97
      ...
      subroutine step_kdk(i1st,time,nbod,npl,ntp,mass,j2rp2,
     &     j4rp4,xh,yh,zh,vxh,vyh,vzh,xht,yht,zht,vxht,vyht,vzht,
     &     istat,rstat,dt,bar)	

      include '../../swift.inc'

c...  Inputs Only: 
      integer nbod,ntp,i1st,npl
...
c...     next the test particles
         call step_kdk_tp(i1sttp,time,nbod,npl,ntp,mass,j2rp2,j4rp4,
     &        xbeg,ybeg,zbeg,xend,yend,zend,xht,yht,zht,vxht,vyht,vzht,
     &        istat,dt,bar)
      endif
