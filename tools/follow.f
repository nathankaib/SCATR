...
c Get data for the run and the test particles
	...
	call io_init_tp(intpfile,ntp,xht,yht,zht,vxht,vyht,
     ...
     &               11 12 13 14 15 16'
        write(*,*) 't,m,a,e,inc,capom,omega,capm,peri,apo,
     &               x,  y,z, vx,vy,vz'
 ...
 1      continue
             ...
             do i=2,nbod
                if(btest(iflgchk,0))  then ! bit 0 is set
                   ...
                   ierr = io_read_line_r(iu,id,m,a,e,inc,capom,omega,
     &                capm,x,y,z,vx,vy,vz) 
                endif
                if(ierr.ne.0) goto 2
                if(id.eq.ifol) then
                   ...
                   peri = a*(1.0d0-e)
                   apo = a*(1.0d0+e)
                   write(7,1000) t,m,a,e,inc,capom,omega,capm,peri,apo,
     &		      x,y,z,vx,vy,vz
