...
c Last revision:  5/10/94 HFL
	...
	subroutine io_dump_star(dparfile,dens,relv,cluslife,clusm,pluma,
     &     xsun,ysun,zsun,vxsun,vysun,vzsun,clusmin,clusmax)	

	include '../swift.inc'
	include 'io.inc'

c...   Inputs
	integer clusmin,clusmax
	real*8 dens,relv,cluslife,xsun,ysun,zsun,vxsun,vysun
        real*8 vzsun,clusm,pluma
	character*(*) dparfile
...
c Open parameter data file for the dump
	...
	write(7,*) cluslife
	write(7,*) clusm,pluma
	write(7,*) xsun,ysun,zsun
	write(7,*) vxsun,vysun,vzsun
	write(7,*) clusmin
	write(7,*) clusmax
